...
const BrowseMovies = () => {
    ...
    const getSearch = (valueQuality, valueGenre, valueRating, valueYear, valueOrder) => {
        setLoaded(false)
            ...
            <div className="movies-queries">
                ...
                <div className="input-field">
                    <div className="input-group">
                        <select name="quality" defaultValue="all" onChange={(e) => setQuality(e.target.value)}>
                    ...
                    <div className="input-group">
                        <select name="genre" defaultValue="all" onChange={(e) => setGenre(e.target.value)}>
                            <option value="all">All</option>
                    ...
                    <div className="input-group">
                        <select name="rating" defaultValue="all" onChange={(e) => setRating(e.target.value)}>
                    ...
                    <div className="input-group">
                        <select name="year" defaultValue="all" onChange={(e) => setYear(e.target.value)}>
                            <option value="0">All</option>
                    ...
                    <div className="input-group">
                        <select name="language" defaultValue="all" onChange={(e) => setLanguage(e.target.value)}>
                    ...
                    <div className="input-group">
                        <select name="order_by" defaultValue="latest" onChange={(e) => setOrder(e.target.value)}>
                    ...
                    <div className="input-group">
                        <div className="pagination search">
                            <Link role="button" to={`/movies/browse-movies/quality=${quality}/genre=${genre}/rating=${rating}/year=${year}/language=${language}/order_by=${order}/page=${page}`} onClick={() => getSearch(quality, genre, rating, year, language, order)}>Search</Link>
                        </div>
                    </div>
                </div>
            </div>
            <div className="loading">
                ...
                }
                {
                    page >= 1 && moviesList?.length > 0 ?
                        ...
                        : page == 15 && page > 1 && moviesList?.length > 0 ?
                            <div>
                                <div className="pagination">
                                    <Link role="button" to={`/movies/browse-movies/quality=${quality}/genre=${genre}/rating=${rating}/year=${year}/language=${language}/order_by=${order}/page=${page + 1}`} onClick={nextPage}>Next page</Link>
                                </div>
